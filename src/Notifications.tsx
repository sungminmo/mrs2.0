...
export type NotificationItem = { id: string; title: string; description: string; code: string; read: boolean; category: keyof typeof notificationTypes; date: string; dateLabel: string }

export default function Notifications({ navigation, items, onRead, onAssets, onSales, onSettlements }: { navigation: ReactNode; items: NotificationItem[]; onRead: (ids: string[]) => void; onAssets: () => void; onSales: () => void; onSettlements: () => void }) {
